...
*Например:*  checkout (Название ветки)

**checkout -b (Название ветки)** — создаст ветку, в которую и произойдет переключение.
...
Можно вывести список удалённых веток с помощью флага -a: *git branch -a.*
